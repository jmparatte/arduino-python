...
# ----------------------
#SERIAL1_COM = 'COM4'
#SERIAL1_COM = (__argc==2 ? __argv[1] : "")
#SERIAL1_COM = (__argc>=2 ? __argv[2-1] : "")
#SD_ROOTNAME = 'A:'
#SD_ROOTNAME = 'H:\\SD'
#SD_ROOTNAME = "%CD%"
...
if ARDUINO_ARCH_WIN32:
    ...
    LED_BUILTIN = -1 # no configured built-in LED
    SERIAL1_COM = 'COM91' # FTDI/Win32
    ...
    LED_BUILTIN = -1 # no configured built-in LED
    SERIAL1_COM = '/dev/ttyUSB0' # FTDI/Linux
    SD_ROOTNAME = '.' # start folder of app
    #WIRE_I2C_NUM = n # I2C device not available
    #WIRE_SCL_PIN = n
    #WIRE_SDA_PIN = n
    ...
    # -----------------
    LED_BUILTIN = -1 # no configured built-in LED
    SERIAL1_UART_NUM = 0 # device UART0
    SERIAL1_TX_PIN = 8 # GPIO 14
    SERIAL1_RX_PIN = 10 # GPIO 15
    #SERIAL2_PORT = '/dev/ttyUSB0' # FTDI/Linux
    SD_ROOTNAME = '.' # start folder of app
    WIRE_I2C_NUM = 1 # device i2c-1
    #WIRE_SCL_PIN = 5 # GPIO 5, do not change !
